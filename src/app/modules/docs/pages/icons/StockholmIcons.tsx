...
// import { VCSVG, toAbsoluteUrl } from "../../../../../_start/helpers";
// import { CodeBlock } from "../../../../../_start/partials";
// import { StockholmIconList } from "./StockholmModels";
// import { DItem } from './IconModels';

// export function StockholmIcons() {
...
//         </h1>
//         <div className="py-5">
//           Use over 1000 high quality vector stockholm SVG icons as image or inline
...
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Design/Adjust.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Code/Git3.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Communication/Chat2.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Design/Brush.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Design/Sketch.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Files/File-plus.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/General/Settings-2.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Tools/Tools.svg")}
//               className="h-40px me-10"
//             />
//             <img
//               src={toAbsoluteUrl("/media/icons/stockholm/Shopping/Chart-bar3.svg")}
//               className="h-40px me-10"
//             />
//           </div>
//         </div>
...
//             />
//             <VCSVG
//               path="/media/icons/stockholm/General/Settings-2.svg"
//               className="svg-icon svg-icon-3x me-10"
//             />
//             <VCSVG
...
//         </h1>
//         <div className="py-10">
//           {StockholmIconList.map((list, index) => (
//             <div key={`k${index}`}>
...
//             {isSvg && icon && (
//               `<VCSVG path="${icon.path}" className="svg-icon-muted svg-icon-2hx" />`
//             )}
