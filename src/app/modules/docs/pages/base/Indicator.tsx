...
export function Indicator() {
  ...
  const onClick = () => {
    ...
    btnRef.current?.setAttribute("data-hb-indicator", "on");
    setTimeout(() => {
      // Activate indicator
      btnRef.current?.removeAttribute("data-hb-indicator");
    }, 3000);
  };
    ...
    <>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          ...
          <code>data-hb-indicator="on"</code>custom HTML attribute:
        </div>
        <div className="py-5">
...
<button type="button" className="btn btn-primary" data-hb-indicator="on">
    <span className="indicator-label">
        Submit
    </span>
    <span className="indicator-progress">
...
// in your HTML add
<button ref={btnRef} onClick={onClick} type="button" className="btn btn-primary me-10" id="hb_button_1">
  <span className="indicator-label">Submit</span>
