  ...
  return (
    <>
      ...
      <div className="pt-10">
        ...
        <div className="py-5">
          Click the below toggle button to see a slightly customized modal with
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <button
              ...
              data-bs-target="#hb_modal_1"
            >
              Launch demo modal
            </button>
            <div className="modal fade" tabIndex={-1} id="hb_modal_1">
      ...
      <div className="pt-10">
        ...
        <div className="py-5">
          Add
          <code>.modal-fullscreen</code>class to enable a modal with fullscreen
          mode. Add
          <code>.bg-white</code>and
          <code>.shadow-none</code>classes to fix background color and unwanted
          shadow issue when modal has a long scrollable content.
        </div>
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <button
              ...
              className="btn btn-primary"
              data-bs-toggle="modal"
              data-bs-target="#hb_modal_2"
            >
              Launch demo modal
            </button>
            <div className="modal bg-white fade" tabIndex={-1} id="hb_modal_2">
