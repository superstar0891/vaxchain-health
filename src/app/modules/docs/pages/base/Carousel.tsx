  ...
  return (
    <>
      ...
      <div className="pt-10">
        ...
        <div className="py-5">
          Add
          <code>.carousel-custom</code>to use a customized carousel as shown
          below:
        </div>
        <div className="py-5">
          <div className="rounded border p-10">
            <div
              id="hb_carousel_1_carousel"
            ...
            >
              <div className="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <ol className="p-0 m-0 carousel-indicators carousel-indicators-dots">
                  <li
                    data-bs-target="#hb_carousel_1_carousel"
                    data-bs-slide-to="0"
...
const code = `<div id="hb_carousel_1_carousel"
  className="carousel carousel-custom slide"
  data-bs-ride="carousel"
  data-bs-interval="8000"
>
