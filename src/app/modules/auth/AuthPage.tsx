...
export function AuthPage() {
  ...
  return (
    <div className="d-flex flex-column flex-root">
      ...
      >
        {/* Aside */}
        <div className="d-flex flex-column flex-lg-row-auto bg-success w-lg-600px pt-15 pt-lg-0">
          {/* Top */}
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${toAbsoluteUrl(
                "/media/illustrations/verification.png"
              )})`,
            }}
          ></div>
        </div>
