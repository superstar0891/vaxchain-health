...
import { requestPassword } from "setup/request/auth.request";
  ...
  return (
    <>
      <form
        ...
        noValidate
        id="hb_login_password_reset_form"
      ...
      >
        ...
        <div className="d-flex flex-wrap pb-lg-0">
          <button
            type="submit"
            id="hb_login_password_reset_form_submit_button"
          ...
          <Link to="/auth/login">
            <button
              type="button"
              id="hb_login_password_reset_form_cancel_button"
