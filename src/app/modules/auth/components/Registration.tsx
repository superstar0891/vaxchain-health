...
import { register } from "setup/request/auth.request";
  ...
  return (
    ...
    >
      ...
      <div className="d-flex flex-wrap pb-lg-0 pb-5">
        <button
          type="submit"
          id="hb_login_signup_form_submit_button"
        ...
        <Link to="/auth/login">
          <button
            type="button"
            id="hb_login_signup_form_cancel_button"
