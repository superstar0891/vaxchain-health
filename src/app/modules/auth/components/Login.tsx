...
export function Login() {
  ...
  return (
    <form
      ...
      noValidate
      id="hb_login_signin_form"
    >
      {/* begin::Title */}
      <div className="pb-lg-15">
        <h3 className="fw-bolder text-dark display-6">Welcome to VaxChain Health</h3>
        <div className="text-muted fw-bold fs-3">
          New Here?{" "}
          <Link
            to="/auth/registration"
            className="text-primary fw-bolder"
            id="hb_login_signin_form_singup_button"
          >
            Create Account
          </Link>
        </div>
      ...
      <div className="fv-row mb-10 fv-plugins-icon-container">
        <div className="d-flex justify-content-between mt-n5">
          ...
          <Link
            ...
            id="hb_login_signin_form_password_reset_button"
          >
            Forgot Password ?
          </Link>
        </div>
