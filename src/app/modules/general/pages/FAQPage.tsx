            ...
            >
              ...
              <div className="mb-5">
                ...
                <div
                  ...
                  data-bs-target="#hb_accordion_1_item_1"
                >
              ...
              <div className="mb-5">
                ...
                <div
                  ...
                  data-bs-toggle="collapse"
                  data-bs-target="#hb_accordion_1_item_2"
                >
                  <span className="accordion-icon">
                    <VCSVG
                      className="svg-icon-4"
              ...
              <div className="mb-5">
                ...
                <div
                  className="accordion-header py-3 d-flex collapsed"
                  data-bs-toggle="collapse"
                  data-bs-target="#hb_accordion_1_item_3"
                >
                  <span className="accordion-icon">
                    <VCSVG
                      className="svg-icon-4"
              ...
              <div className="mb-5">
                ...
                <div
                  className="accordion-header py-3 d-flex collapsed"
                  data-bs-toggle="collapse"
                  data-bs-target="#hb_accordion_1_item_4"
                >
                  <span className="accordion-icon">
                    <VCSVG
                      className="svg-icon-4"
              ...
              <div className="mb-5">
                ...
                <div
                  className="accordion-header py-3 d-flex collapsed"
                  data-bs-toggle="collapse"
                  data-bs-target="#hb_accordion_1_item_5"
                >
                  <span className="accordion-icon">
                    <VCSVG
                      className="svg-icon-4"
