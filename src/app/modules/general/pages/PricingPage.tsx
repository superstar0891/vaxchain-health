        ...
        <div className="row mb-12">
          <div className="col-md-4 col-lg-12 col-xl-4 col-xxl-3 d-flex flex-center">
            ...
            >
              <a
                ...
                id="hb_nav_monthly"
                data-bs-toggle="tab"
                href="#hb_nav_monthly_content"
                role="tab"
                aria-controls="hb_nav_monthly"
                aria-selected="true"
              >
                Monthly
              </a>
              <a
                ...
                id="hb_nav_annually"
                data-bs-toggle="tab"
                href="#hb_nav_annually_content"
                role="tab"
                aria-controls="hb_nav_annually"
                aria-selected="false"
              >
                Annually
              </a>
          ...
          <div className="col-md-8 col-lg-12 col-xl-8 col-xxl-9">
            ...
            <div className="tab-content" id="nav-tabContent">
              ...
              <div
                id="hb_nav_monthly_content"
                className="tab-pane fade show active"
                role="tabpanel"
                aria-labelledby="hb_nav_monthly"
              >
                <div className="row">
              ...
              <div
                id="hb_nav_annually_content"
                className="tab-pane fade"
                role="tabpanel"
                aria-labelledby="hb_nav_annually"
              >
                <div className="row">
                  <div className="col-md-4 col-lg-12 col-xl-4">
                    <div className="d-flex flex-column text-center px-9 py-12 justify-content-center">
