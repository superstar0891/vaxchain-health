      ...
      <div className="container px-10 py-10">
        ...
        <div className="modal-body">
          ...
          <div
            ...
            id="hb_modal_create_app_stepper"
          >
            {/*begin::Aside */}
            <div className="d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px">
              ...
              <div className="stepper-nav d-flex flex-column pt-5">
                ...
                {/*begin::Step 2 */}
                <div className="stepper-item" data-hb-stepper-element="nav">
                  <div className="stepper-wrapper">
                    <div className="stepper-icon">
                      <i className="stepper-check fas fa-check"></i>
            ...
            <div className="d-flex flex-row-fluid justify-content-center">
              ...
              <form
                ...
                noValidate
                id="hb_modal_create_app_form"
              >
                {/*begin::Step 1 */}
                <div className="pb-5 current" data-hb-stepper-element="content">
                  <div className="w-100">
                    {/*begin::Heading */}
                ...
                {/*begin::Step 2 */}
                <div className="pb-5" data-hb-stepper-element="content">
                  <div className="w-100">
                    {/*begin::Heading */}
