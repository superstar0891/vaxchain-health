          ...
          <div className="card-body p-9">
            <div className="d-flex align-items-stretch mb-20">
              <div
                ...
                data-hb-drawer="true"
                data-hb-drawer-name="header-menu"
                data-hb-drawer-activate="{default: true, lg: false}"
                data-hb-drawer-overlay="true"
                data-hb-drawer-width="{default:'200px', '300px': '250px'}"
                data-hb-drawer-direction="start"
                data-hb-drawer-toggle="#hb_header_menu_toggle"
              >
                <div
                ...
                >
                  ...
                  <div
                    ...
                    data-hb-menu-placement="bottom-start"
                  ...
                  >
                    ...
                    >
                      <div
                        data-hb-menu-trigger="click"
                        data-hb-menu-placement="right-start"
                        className="menu-item"
                      >
                        <span className="menu-link py-3">
                      ...
                      <div data-hb-menu-trigger="click" className="menu-item">
                        <span className="menu-link py-3">
                          <span className="menu-icon">
                            <span className="svg-icon">
                              <SVG
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ margin: "0px" }}
                    >
                      <div className="row" data-hb-menu-dismiss="true">
            ...
            <div className="mb-20 w-200px">
              <div
                ...
                data-hb-menu-target="#hb_header_search_menu"
                data-hb-menu-trigger="click"
                data-hb-menu-permanent="true"
                data-hb-menu-placement="bottom-start"
              >
              ...
              <div
                ...
                data-hb-menu="true"
                id="hb_header_search_menu"
                style={{ margin: "0px" }}
              >
                <div
                  id="hb_header_search"
                  data-hb-search-keypress="true"
                  data-hb-search-min-length="3"
                  data-hb-search-enter="enter"
                  data-hb-search-mode="inline"
                  data-hb-search-input-focus="true"
                  data-hb-search-trigger="#hb_header_search_trigger"
                  data-hb-search-input="#hb_header_search_input"
                  data-hb-search-spinner="#hb_header_search_spinner"
                  data-hb-search-clear="#hb_header_search_clear"
                  data-hb-search-results="#hb_header_search_results"
                  data-hb-search-suggestions="#hb_header_search_suggestions"
                  data-hb-search-empty="#hb_header_search_empty"
                >
                  ...
                  <div id="hb_header_search_results" className="d-none"></div>

                  <div id="hb_header_search_suggestions">Suggestions</div>
                  <div id="hb_header_search_empty" className="d-none">
