...
class ScrollTopComponent {
  ...
  private _scroll = () => {
    ...
    if (pos > offset) {
      if (!document.body.hasAttribute("data-hb-scrolltop")) {
        document.body.setAttribute("data-hb-scrolltop", "on");
      }
    } else {
      if (document.body.hasAttribute("data-hb-scrolltop")) {
        document.body.removeAttribute("data-hb-scrolltop");
      }
    }
  };
  ...
  private _getOption = (name: string) => {
    const attr = this.element.getAttribute(`data-hb-scrolltop-${name}`);
    if (attr) {
  ...
  public static bootstrap = () => {
    ScrollTopComponent.createInstances('[data-hb-scrolltop="true"]');
  };
