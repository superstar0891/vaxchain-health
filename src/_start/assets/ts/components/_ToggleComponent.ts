...
class ToggleComponent {
  ...
  constructor(_element: HTMLElement, options: ToggleOptions) {
    ...
    const elementTargetAttr = this.element.getAttribute(
      "data-hb-toggle-target"
    );
    if (elementTargetAttr) {
      this.target = document.querySelector(elementTargetAttr);
    }
    const elementToggleAttr = this.element.getAttribute("data-hb-toggle-state");
    this.state = elementToggleAttr || "";
    this.attribute =
      "data-hb-" + this.element.getAttribute("data-hb-toggle-name");
  ...
  public static reinitialization = () => {
    ToggleComponent.createInstances("[data-hb-toggle]");
  }
