...
class StickyComponent {
  ...
  constructor(_element: HTMLElement, options: StickyOptions) {
    ...
    this.instanceName = this.element.getAttribute("data-hb-sticky-name");
    this.attributeName = "data-hb-sticky-" + this.instanceName;
  ...
  private getOption = (name: string) => {
    const dataStickyAttr = "data-hb-sticky-" + name;
  ...
  public static bootstrap(attr: string = '[data-hb-sticky="true"]') {
    StickyComponent.createInstances(attr);
  }

  public static reInitialization(attr: string = '[data-hb-sticky="true"]') {
    StickyComponent.createInstances(attr);
  }
}
