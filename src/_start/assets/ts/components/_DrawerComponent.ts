...
class DrawerComponent {
  ...
  constructor(_element: HTMLElement, options: DrawerOptions) {
    ...
    this.name = this.element.getAttribute("data-hb-drawer-name") || "";
    this.shown = false;
  ...
  private _update = () => {
    ...
    const bodyCanvasAttr = String(
      document.body.getAttribute(`data-hb-drawer-${this.name}-`)
    );
  ...
  private _getOption = (name: string) => {
    const attr = this.element.getAttribute(`data-hb-drawer-${name}`);
    if (attr) {
  ...
  private _hide = () => {
    ...
    this.shown = false;
    this._deleteOverlay();
    document.body.removeAttribute(`data-hb-drawer-${this.name}`);
    document.body.removeAttribute(`data-hb-drawer`);
  ...
  private _show = () => {
    ...
    this.shown = true;
    this._createOverlay();
    document.body.setAttribute(`data-hb-drawer-${this.name}`, "on");
    document.body.setAttribute("data-hb-drawer", "on");
  ...
  public static bootstrap = () => {
    DrawerComponent.createInstances('[data-hb-drawer="true"]');
