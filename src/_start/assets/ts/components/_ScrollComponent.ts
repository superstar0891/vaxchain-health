...
class ScrollComponent {
  ...
  private getOption = (name: string) => {
    if (this.element.hasAttribute("data-hb-scroll-" + name) === true) {
      const attr = this.element.getAttribute("data-hb-scroll-" + name) || "";
  ...
  public update = () => {
    ...
    if (
      ...
      !this.element.hasAttribute("data-hb-scroll-activate")
    ) {
      this.setupHeight();
  ...
  public static destroyAll(attr: string = '[data-hb-scroll="true"]') {

  }

  public static bootstrap(attr: string = '[data-hb-scroll="true"]') {
  ...
  public static reinitialization(attr: string = '[data-hb-scroll="true"]') {
    ScrollComponent.createInstances(attr);
  }
