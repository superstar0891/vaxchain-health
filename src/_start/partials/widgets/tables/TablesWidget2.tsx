      ...
      <div className="card-body pt-3 pb-0 mt-n3">
        <div className="tab-content mt-4" id="myTabTables2">
          ...
          <div
            id="hb_tab_pane_2_1"
            role="tabpanel"
            aria-labelledby="hb_tab_pane_2_1"
          ...
          <div
            id="hb_tab_pane_2_2"
            role="tabpanel"
            aria-labelledby="hb_tab_pane_2_2"
          ...
          <div
            id="hb_tab_pane_2_3"
            role="tabpanel"
            aria-labelledby="hb_tab_pane_2_3"
            className="tab-pane fade"
          >
            {/* begin::Table */}
            <div className="table-responsive">
