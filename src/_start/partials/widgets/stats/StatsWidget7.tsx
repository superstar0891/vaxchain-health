    ...
    <div className={`card ${className}`}>
      ...
      <div className={`card-body ${innerPadding}`}>
        ...
        <div className="mb-10">
          ...
          {/* begin::Row */}
          <div className="row" data-hb-control="toggle-buttons">
            <input
              type="radio"
              className="btn-check"
              name="form-options"
