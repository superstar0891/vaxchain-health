...
import { toAbsoluteUrl, VCSVG } from "../../../helpers";
...
const chartsData: Array<{
  ...
  {
    tabId: 0,
    selector: "#hb_sidebar_tab_1_chart",
    values: [40, 30, 25, 40, 50, 30],
  },
  {
    tabId: 1,
    selector: "#hb_sidebar_tab_2_chart",
    values: [30, 30, 25, 45, 30, 40],
  },
  {
    tabId: 2,
    selector: "#hb_sidebar_tab_3_chart",
    values: [25, 30, 40, 30, 35, 30],
  },
  {
    tabId: 3,
    selector: "#hb_sidebar_tab_4_chart",
    values: [25, 30, 35, 40, 50, 30],
  },
  {
    tabId: 4,
    selector: "#hb_sidebar_tab_5_chart",
...
export function SidebarGeneral() {
  ...
  return (
    <>
      ...
      {/* begin::Sidebar Content */}
      <div id="hb_sidebar_content" className="py-10 px-5 px-lg-5">
        <div
          className="hover-scroll-y me-lg-n2 pe-lg-2"
          data-hb-scroll="true"
          data-hb-scroll-height="auto"
          data-hb-scroll-offset="10px"
          data-hb-scroll-dependencies="#hb_sidebar_tabs, #hb_sidebar_footer"
          data-hb-scroll-wrappers="#hb_sidebar_content"
        >
          <div className="tab-content">
            <div
              className={clsx("tab-pane", { active: activeTab === 0 })}
              id="hb_sidebar_tab_pane_1"
              role="tabpanel"
            >
              {/* begin::Card */}
      ...
      <div id="hb_sidebar_footer" className="py-2 px-5 pb-md-6 text-center">
        <a
          href="#"
