      ...
      <div className="row">
        <div className="col-sm-4">
          ...
          <ul className="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
            ...
            <li className="menu-item">
              <MenuItem to="/organization" title="Organization Management" />
            </li>
            <li className="menu-item">
      ...
      <div className="row">
        <div className="col-sm-4">
          ...
          <ul className="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
            ...
            <li className="menu-item">
              <a href="#" className="menu-link ps-0 py-2" data-hb-page="pro">
                Account
        ...
        <div className="col-sm-4">
          ...
          <ul className="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-bold fs-6 mb-10">
            ...
            <li className="menu-item">
              <a className="menu-link ps-0 py-2" href="#" data-hb-page="pro">
                Layout Builder
                <span className="badge badge-pro badge-light-danger fw-bold fs-9 px-2 py-1 ms-1">
                  Pro
                </span>
