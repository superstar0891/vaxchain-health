...
import { VCSVG, toAbsoluteUrl } from "../../../helpers";
            ...
            <div className="aside-primary d-flex flex-column align-items-center flex-row-auto">
              ...
              >
                <div
                  ...
                  data-hb-scroll-dependencies="#hb_aside_logo, #hb_aside_footer"
                  data-hb-scroll-wrappers="#hb_aside_nav"
              ...
              >
                {config.aside.secondaryDisplay && config.aside.toggle && (
                  <button
                    ...
                    id="hb_aside_toggle"
                    data-hb-toggle="true"
                    data-hb-toggle-state="active"
                    data-hb-toggle-target="body"
                    data-hb-toggle-name="aside-minimize"
                    title="Toggle Aside"
                  >
                    <VCSVG
                ...
                >
                  <button
                    ...
                    data-hb-menu-placement="top-start"
          ...
          {config.aside.secondaryDisplay && (
            <div className="aside-secondary d-flex flex-row-fluid">
              <div
                ...
                className="aside-workspace my-7"
                id="hb_aside_wordspace"
              >
                {!config.aside.primaryDisplay ? (
                  <>
                    {/* begin::Logo */}
                    <div className="aside-logo pt-12 pb-12 ps-5 pe-4 ps-lg-10 pe-lg-6" id="hb_aside_logo">
                      <Link to="/">
                        <img
                          alt="Logo"
                          src={toAbsoluteUrl("/media/logos/logo-compact.svg")}
                  ...
                  <div className="tab-content">
                    ...
                    {/* begin::Demo menu */}
                    <div className="tab-pane fade" id="hb_aside_tab_2">
                    ...
                    {/* begin::Demo menu */}
                    <div className="tab-pane fade" id="hb_aside_tab_3">
                      Lorem Ipsum is simply dummy text of the printing and
                      typesetting industry. Lorem Ipsum has been the industry's
                      standard dummy text ever since the 1500s, when an unknown
                      printer took a galley of type and scrambled it to make a
